...
v10.2
> Задачи:
>  * Добавил ссылки на решения второй задачи к девятой лекции и первой и второй задач к десятой лекции (когда руки дойдут переписать решения в файл, плюсы в табличке пожирнеют).
...
>    * было (как бы) пояснено, почему отображение склейки h в принципе отражения непрерывно (теорема 7.2);
